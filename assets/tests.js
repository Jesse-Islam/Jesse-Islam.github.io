...
define("ember-quickstart/tests/lint/app.lint-test", [], function () {
  ...
  QUnit.test('routes/programmer.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/programmer.js should pass ESLint\n\n');
  });
...
define("ember-quickstart/tests/lint/templates.template.lint-test", [], function () {
  ...
  QUnit.test('ember-quickstart/templates/components/people-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-quickstart/templates/components/people-list.hbs should pass TemplateLint.\n\nember-quickstart/templates/components/people-list.hbs\n  5:8  error  Interaction added to non-interactive element  no-invalid-interactive\n');
  });
  QUnit.test('ember-quickstart/templates/programmer.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-quickstart/templates/programmer.hbs should pass TemplateLint.\n\n');
  });
...
define("ember-quickstart/tests/lint/tests.lint-test", [], function () {
  ...
  QUnit.test('unit/routes/programmer-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/programmer-test.js should pass ESLint\n\n');
  });
...
define("ember-quickstart/tests/unit/routes/programmer-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  "use strict";

  (0, _qunit.module)('Unit | Route | programmer', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:programmer');
      assert.ok(route);
    });
  });
});
